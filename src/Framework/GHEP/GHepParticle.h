...
public :
 ...
 ~GHepParticle();
  ...
  double PolzPolarAngle   (void) const { return this->PolzIsSet()?fPolarization.Theta():-999; } //TODO using -999 to match previous code null value, but would NaN be better?
  double PolzAzimuthAngle (void) const { return this->PolzIsSet()?fPolarization.Phi():-999; } //TODO using -999 to match previous code null value, but would NaN be better?
